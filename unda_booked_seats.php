<?php
    $file = fopen("unda_seats.txt","a");
    $my_file = 'unda_seats.txt';
    ...
    else
    {
        ...
        {    
            $sql="UPDATE seats SET available_seats=available_seats-$count_seats WHERE movie_id=4";
            ...
            $sql="INSERT INTO billing VALUES('$bill_id',4,'$count_seats','INOX- Lido','$phone_number')";
            if(!mysqli_query($con,$sql))
            {
                echo 'Oops! Try again later!';
            }
