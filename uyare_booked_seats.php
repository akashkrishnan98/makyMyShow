<?php
    $file = fopen("uyare_seats.txt","a");
    $my_file = 'uyare_seats.txt';
    ...
    else
    {
        ...
        {    
            $sql="UPDATE seats SET available_seats=available_seats-$count_seats WHERE movie_id=6";
            ...
            $sql="INSERT INTO billing VALUES('$bill_id',6,'$count_seats','PVR- Mantri','$phone_number')";
            if(!mysqli_query($con,$sql))
            {
                echo 'Oops! Try again later!';
            }
