<?php
    $file = fopen("asuran_seats.txt","a");
    $my_file = 'asuran_seats.txt';
    ...
    else
    {
        ...
        {    
            $sql="UPDATE seats SET available_seats=available_seats-$count_seats WHERE movie_id=3";
            ...
            {    
                echo "<html>
                        ...
                        <ul class='nav_menu'>
                            ...
                            <li class='nav_items'><a href='home.html'>Home</a></li>
                        </ul>
            ...
            $sql="INSERT INTO billing VALUES('$bill_id',3,'$count_seats','PVR- Phoenix','$phone_number')";
            if(!mysqli_query($con,$sql))
            {
                echo 'Oops! Try again later!';
            }
