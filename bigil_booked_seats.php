<?php
    $file = fopen("bigil_seats.txt","a");
    $my_file = 'bigil_seats.txt';
    ...
    else
    {
        ...
        {    
            $sql="UPDATE seats SET available_seats=available_seats-$count_seats WHERE movie_id=2";
            ...
            $sql="INSERT INTO billing VALUES('$bill_id',2,'$count_seats','PVR_VR','$phone_number')";
            if(!mysqli_query($con,$sql))
            {
                echo 'Oops! Try again later!';
            }
