...
$booked_seats=file('kaithi_seats.txt');
        ...
        <html>
            ...
            <body>
                    ...
                    <div class='movie_theatre'>
                        <p><strong>Kaithi(Tamil)- SPI</strong></p>
                    </div>
                    <form action='kaithi_booked_seats.php' method='POST'>
                    <div class='seats'>";
            ...
            echo "</div>
                ...
                <div class='submit_container'>
                    Phone No.:<input type='number' name='ph_no' required>
                    <br>                    
